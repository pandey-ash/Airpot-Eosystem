 ...
 * @author ashis
 */
public class AddAirlineEmployeePanel extends javax.swing.JPanel {
    ...
    Airline airline;
    JFrame mainJFrame;
    public AddAirlineEmployeePanel(JFrame mainJFrame, Airline airline,EcoSystem ecoSystem) {
        initComponents();
...
//        jPanel1.setOpaque(false);
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(233, 298, Short.MAX_VALUE))
        );
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        AirlineEmployee employee = ecoSystem.getAirlineEmployeeDirectory().getAirlineEmployeeFromUsername(username);
        if(employee != null)
        {
        ...
        employee = ecoSystem.getAirlineEmployeeDirectory().addAirlineEmployee();
        ...
        showMessageDialog(this, "New employee added successfully");
